...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
	...
	<!--collection-id: get from the first instance of fits/fileinfo/filepath in the FITS XML when the collection-id is formatted harg-ms####-->
	...
	<!--aip-id: get from the first instance of fits/fileinfo/filepath in the FITS XML when the aip-id is formatted harg-ms####er####-->
	...
	<!--aip title: get from the first instance of fits/fileinfo/filepath in the FITS XML when the filepath is formatted any/thing/harg-ms####er####_AIP Title/anything/else-->
